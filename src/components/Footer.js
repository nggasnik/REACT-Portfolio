    ...
    <div className="footer">
        <div className="footer-container">
            <div className="left">
                ...
                nggasnik@icloud.com</h4>
                 </div>
            </div>
            
            <div className="right">
                <h4>About Me</h4>
                <p>Saya mahasiswa semester 3 Universitas Gunadarma.
                    Saya senang diskusi tentang hal-hal yang berbau teknologi.</p>
